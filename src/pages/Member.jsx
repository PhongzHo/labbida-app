...
const MemberPage = () => {
  ...
  return (
    <div className="text-white mt-32 bg-black ">
      <button className="bg-pink rounded p-4" onClick={() => {
        axios.post('connect/token',
        "scope=PublicApi.Access.FNB&grant_type=client_credentials&client_id=6538e4e0-c942-48ec-b806-7f17ae71bf7d&client_secret=C51EA27C629DA3528AA18D747A9EA9F715D27BA6",
        {
            headers: {
              "Content_Type": "application/x-www-form-urlencoded"
            }
